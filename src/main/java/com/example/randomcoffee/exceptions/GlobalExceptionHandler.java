package com.example.randomcoffee.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> duplicateKeyValue(DataIntegrityViolationException ex){
        ...
        return ResponseEntity.status(400).body(new ErrorMessage(String.format("user with this id already exist: %s", parameter)));
    }
}
